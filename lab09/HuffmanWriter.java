 ...
 *
 * Version:
 *    $Id: HuffmanWriter.java,v 1.1 2013/10/08 16:00:54 csci140 Exp $
 *
 * Revisions:
 ...
 *
 *    Revision 1.9  2001/05/10 13:34:26  cs2
 *    Fixed typo
 *
...
public class HuffmanWriter extends Writer {
    ...
    private Map<Character, String> tTable = null;
	...
	String bits = tTable.get( new Character( ch ) );
