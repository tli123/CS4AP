 ...
 *
 * Version:
 *     $Id: FrequencyTable.java,v 1.1 2013/10/08 16:00:54 csci140 Exp $
 *
 * Revisions:
 ...
 *     Initial revision
 *
 *     Revision 1.10  2013/10/03 19:17:22  csci140
 *     made changes to support generics
 *
 *     Revision 1.9  2004/02/07 16:42:33  cs2
 *     fixed the JavaDoc
 *
 *     Revision 1.8  2001/05/07 18:13:37  cs2
 *     Fixed to 20001 style standards
 *
 *     Revision 1.7  2001/02/03 22:12:59  cs2
 *     Removed javadoc second * on file comment
 *
 *     Revision 1.6  2001/01/29 23:33:42  cs2
 *     kaa fixed header
 *
 *
 */
...
public class FrequencyTable {
     ...
     * to the file.
     *
     * @param    out    the stream to write the table to.
     *
     * @exception    IOException    if an I/O error occurs.
     */
     ...
     * of one.
     *
     * @param    ch    the character whose frequency is to be incremented.
     */
